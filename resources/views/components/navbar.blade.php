<nav class="bg-gray-800"  x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            ...
            <div class="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/teams" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Teams</a>
            </div>
            </div>
        </div>
        <div class="hidden md:block">
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Teams</a>
        </div>
