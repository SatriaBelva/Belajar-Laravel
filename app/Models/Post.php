...
class Post extends Model // Dengan memberikan extends maka class Post akan mewarisi atau menginherit perilaku yang ada dalam class Model
                         // Dengan ini maka laravel akan memetakan class Post dengan sebuah tabel dengan nama Post di database kita
{
    ...
    // public static function all() // Sudah tidak dibutuhkan karena dalam class Model sudah terdapat method all()
    // {
    //     return [
    //         [
    //             'id'    => 1,
    ...
    // public static function find($slug): array // Sudah tidak dibutuhkan karena dalam class Model sudah terdapat method find()
    // {
